...
¦   L-- workflows/                       # GitHub Actions — автоматизация при пушах
¦       L-- ci-cd.yml                    # Пайплайн: при пуше в main собирает образ, пушит в Docker Hub, обновляет тег в манифестах
¦
...
¦   ¦
¦   L-- monitoring/                       # Всё для наблюдения за приложением
...
¦           L-- promtail-rbac.yaml         # Права для Promtail: чтобы имел доступ к логам на нодах
¦
...
L-- start.sh                              # Скрипт для полного развертывания на Linux (протестировано в Ubuntu 24.04 LTS)
```

## Запуск на Windows (локально)

Выполняй по шагам в PowerShell:
